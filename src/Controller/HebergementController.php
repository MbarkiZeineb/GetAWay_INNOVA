...
class HebergementController extends AbstractController
{
    ...
    /**
     * @Route ("/affheball", name="heb_all", methods={"GET"})
     */
    public function indexall(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('hebergement/afficherHebAll.html.twig', [
    ...
    /**
     * @Route("/new/{ido}", name="app_hebergement_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager,$ido): Response
    {
        $user= $entityManager->getRepository(User::class)->find($ido);
        $hebergement = new Hebergement();
        $hebergement->setOffreur($user);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_hebergement_index',['ido'=>$hebergement->getOffreur()->getId()]);
        }
